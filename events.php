    ...
    <div class="mt-5 inner" id="contact-us">
      <div class="row">
        ...
        <div class="col-lg-12 col-sm-12" data-aos="zoom-in" data-aos-delay="200">
          <div class="formsubmit max-w-2xl mx-auto !bg-gray-50 p-8 rounded-lg shadow-lg">
