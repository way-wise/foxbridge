...
<head>
  ...
  <title>Who owns Foxbridge Golf Club, where are they located in Canada</title>
  <meta name="description"
    content="200 acres of pristine natural beauty splitting into North and South course each with 9 holes, offers players variety and opportunity to experience different landscapes & challenges" />
...
<body>
  ...
  <section class="pb-0 pb-xl-5 pt-3 mt-5">
    <div class="container">
      <div class="row g-4 justify-content-between align-items-center">
        ...
        <div class="col-lg-5 position-relative">
          ...
          <!-- Svg decoration -->
          <figure class="position-absolute top-0 start-0 d-none d-md-block mb-n5 me-n4" data-aos="slide-left"
          ...
          <!-- Image -->
          <img src="images/about.jpg" class="rounded-3 position-relative shadow mb-5" alt="" style="width:100%;"
  ...
  <section class="Best_Drivers">
    <div class="container">
      <div class="row mb-5">
        <div class=" col-lg-7 col-md-12 light">
          <div class="content">
            <h2>Play Golf Like A Pro</h2>
            <span class="fancy-border" data-aos="flip-left" data-aos-duration="3000"></span>
            <p>Get the best golf experience </p>
          </div>
        </div>
      </div>
  ...
  <section class="pb-0 pb-xl-5 pt-3 mt-5">
    <div class="container">
      ...
      <div class="col-lg-12 col-sm-12 bottom20" data-aos="fade-up">
        <section class="leauge inner mobborder">
          <div class="">
            <div class="row">
              <div class="col-lg-6 col-md-6 col-12">
                <div class="img_box">
                  <img src="images/proshop-Ali-Nadeem.jpeg">
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-12" style="background: #f8fff1;">
                <div class="p-3">
                  <h2 data-aos="fade-down">ProShop </h2>
                  <span class="fancy-border" data-aos="flip-left" data-aos-duration="3000"></span>
                  <p data-aos="fade-up" class="top20">

                  <div class="row">
                    <div class="col-lg-12 col-md-12 mb-lg-0 mb-md-5 mb-sm-5 content mt-0">
                      <p>Our Golf pro shop has the latest designer golf apparel, sportswear, golf accessories, and golf
                        equipment.
                      </p>
